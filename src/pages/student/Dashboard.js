    ...
    <div className="attendance-circle">
      <svg width="100" height="100" viewBox="0 0 100 100">
        ...
        <circle
          ...
          fill="none" stroke="#2db87b" strokeWidth={stroke}
        ...
        <div className="stat-mini-row">
          <div className="stat-mini">
            <div className="stat-mini-icon icon-green">
              <Icon d="M9 11l3 3L22 4M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" size={20} color="#2db87b" />
            </div>
            <div>
          ...
          <div className="stat-mini">
            <div className="stat-mini-icon icon-blue">
              <Icon d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8" size={20} color="#4f8ef7" />
            </div>
            <div>
          ...
          <div className="stat-mini">
            <div className="stat-mini-icon icon-yellow">
              <Icon d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H6a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3z" size={20} color="#e6a800" />
            </div>
            <div>
              <div className="stat-mini-label">Fee Status</div>
              <div className="stat-mini-value" style={{ color: "#2db87b", fontSize: "15px" }}>
          ...
          <div className="stat-mini">
            <div className="stat-mini-icon icon-purple">
              <Icon d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 8v4l3 3" size={20} color="#9b6dff" />
            </div>
            <div>
            ...
            <div className="card-header">
              <div className="card-title">
                <div className="card-title-icon icon-red">
                  <Icon d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 0 1-3.46 0" size={15} color="#ff5c5c" />
                </div>
                Announcements
              </div>
            ...
            <div className="card-header">
              <div className="card-title">
                <div className="card-title-icon icon-green">
                  <Icon d="M9 11l3 3L22 4" size={15} color="#2db87b" />
                </div>
                Attendance
              </div>
            ...
            <div className="card-header">
              <div className="card-title">
                <div className="card-title-icon icon-blue">
                  <Icon d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" size={15} color="#4f8ef7" />
                </div>
                Marks
              </div>
            ...
            <div className="card-header">
              <div className="card-title">
                <div className="card-title-icon icon-yellow">
                  <Icon d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H6a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3z" size={15} color="#e6a800" />
                </div>
                Fee Challan
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              {[
                ...
                <div key={i} style={{ display: "flex", justifyContent: "space-between", padding: "10px 14px", background: "var(--bg-main)", borderRadius: "8px" }}>
                  ...
                  <span style={{ fontSize: "13px", fontWeight: 800, color: i === 2 ? "#2db87b" : "var(--text-primary)" }}>{row.value}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="dashboard-grid-three">
          ...
          <div className="profile-panel">
            <div className="profile-avatar-wrap">
              ...
              <div className="profile-id-chip">
                <Icon d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" size={12} color="#1e9e63" />
          ...
          <div className="card">
            <div className="card-header">
              <div className="card-title">
                <div className="card-title-icon icon-blue">
                  <Icon d="M18 20V10M12 20V4M6 20v-6" size={15} color="#4f8ef7" />
                </div>
                Progress
              </div>
            </div>
