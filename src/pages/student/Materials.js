...
function MaterialModal({ material, onClose }) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      window.open(downloadSrc, "_blank", "noreferrer");
    } finally {
          ...
          {embedable ? (
            ...
            <div style={{ textAlign: "center" }}>
              ...
              {downloadSrc ? (
                ...
                <div style={{ padding: "16px 24px", borderRadius: "12px", background: "var(--bg-main)", border: "1.5px dashed var(--border)", color: "var(--text-muted)", fontSize: "13px" }}>
                  This material will be available once your teacher uploads a file.
                </div>
              )}
