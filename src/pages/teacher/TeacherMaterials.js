...
function TeacherMaterials() {
  ...
  const handleFileSelect = (e) => {
    ...
    // Create a blob URL — works for preview (iframe) and download (anchor)
        ...
        {showUpload && (
          <div className="card" style={{ border: "2px solid rgba(45,184,123,0.27)", background: "linear-gradient(135deg, #f0fdf7, #fff)" }}>
            <div className="card-header" style={{ marginBottom: "18px" }}>
              ...
              <button onClick={() => { setShowUpload(false); setSelectedFileName(""); }} style={{ background: "none", border: "none", cursor: "pointer", color: "var(--text-muted)" }}>
            ...
            <div style={{ marginTop: "18px", display: "flex", justifyContent: "flex-end", gap: "10px" }}>
              <button onClick={() => { setShowUpload(false); setSelectedFileName(""); }}
