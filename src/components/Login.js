...
const ROLE_DEMOS = {
  student: { email: "student@test.com", password: "1234", label: "Student", color: "#2db87b", hint: "student@test.com / 1234" },
  teacher: { email: "teacher@test.com", password: "1234", label: "Teacher", color: "#4f8ef7", hint: "teacher@test.com / 1234" },
  admin:   { email: "admin@test.com",   password: "1234", label: "Admin",   color: "#9b6dff", hint: "admin@test.com / 1234"   },
};
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleLogin}>
          ...
          <button type="submit" className="btn-primary"
            ...
            Log In as {ROLE_DEMOS[selectedRole]?.label}
          </button>
        </form>
