...
import { teacherCalendar } from "../../data/teacherMockData";
...
function TeacherCalendar() {
  const highlightedDates = teacherCalendar.map(e => e.date);
        ...
        <div className="page-wrapper" style={{ maxWidth: "1040px" }}>
          ...
          <div className="page-header">
            ...
            <div>
              ...
              <div className="page-subtitle">{teacherCalendar.length} events this term</div>
            </div>
          </div>
          ...
          <div className="calendar-layout">
            <div className="events-list">
              ...
              {teacherCalendar.map((event, index) => {
