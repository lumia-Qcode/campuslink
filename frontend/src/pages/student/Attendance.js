...
function Attendance() {
  ...
  // TC-F09: No attendance records at all
  if (!studentAttendance || !(studentAttendance?.records?.length)) {
    return (
      <div className="app-layout">
        ...
        <main className="main-content">
          ...
          <div className="card" style={{ textAlign: "center", padding: "64px 24px" }}>
            ...
            <div style={{ fontSize: "17px", fontWeight: 800, color: "var(--text-primary)", marginBottom: "8px" }}>No Attendance Records Found</div>
