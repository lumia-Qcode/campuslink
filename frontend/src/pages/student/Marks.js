...
function Marks() {
  ...
  // TC-F06: No marks records exist at all
      ...
      <div className="app-layout">
        ...
        <main className="main-content">
          ...
          <div className="card" style={{ textAlign: "center", padding: "64px 24px" }}>
            <div style={{ width: 72, height: 72, borderRadius: "20px", background: "#eff5ff", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
              <Icon d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" size={32} color="#4f8ef7" />
            </div>
            <div style={{ fontSize: "17px", fontWeight: 800, color: "var(--text-primary)", marginBottom: "8px" }}>No Marks Available Yet</div>
