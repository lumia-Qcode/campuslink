...
const materialSchema = new mongoose.Schema(
  {
    ...
    uploadedBy:  { type: String, default: 'Teacher' }, // teacher display name
    uploadedByUserId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null }, // teacher User _id
