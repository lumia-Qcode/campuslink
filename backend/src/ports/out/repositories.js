...
class IStudentRepository {
  ...
  async getLastStudentNumber() { throw new Error('Not implemented'); }
}
...
class ITeacherRepository {
  ...
  async delete(id)             { throw new Error('Not implemented'); }
  async count()                { throw new Error('Not implemented'); }
  async addAssignedSection(teacherId, sectionId)    { throw new Error('Not implemented'); }
  async removeAssignedSection(teacherId, sectionId) { throw new Error('Not implemented'); }
}
...
class ISectionRepository {
  ...
  async findById(id)           { throw new Error('Not implemented'); }
  async findByClassSection(classId, section) { throw new Error('Not implemented'); }
  async findByTeacherId(teacherId) { throw new Error('Not implemented'); }
  async findExact(classId, section, subject) { throw new Error('Not implemented'); }
  async create(data)           { throw new Error('Not implemented'); }
  async update(id, data)       { throw new Error('Not implemented'); }
  async delete(id)             { throw new Error('Not implemented'); }
  async exists(classId, section, subject) { throw new Error('Not implemented'); }
}
